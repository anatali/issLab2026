...
public class AdapterGui {
	 ...
	 */
	public static AdapterGui create(String map_fName) {
		if( instance == null ) { 
			instance = new AdapterGui( map_fName );
		}
		return instance;
	}
	 ...
	 */
	public AdapterGui(String map_fName) {
		// Load grid from map file and initialize dimensions
		grid = maputil.createGridFromMapInFile( map_fName );
	    NR = grid.length;
	    NC = grid[0].length;
	}
