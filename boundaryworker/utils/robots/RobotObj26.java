...
public class RobotObj26  implements IRobotBasicMoves { 
    ...
    protected String toApplMsg        = "msg(vrinfo, event, robotObj26, none, CONTENT, 0)"; 
    ...
    public RobotObj26( IObserverMsg observer, String LogFName) {
        this.observerHl= observer;    	
        this.LogFName  = LogFName;  
    }
    
    public void connectWithRobot(String virtualRobotIp) {
        wsconn    = new WsconnObserver(virtualRobotIp,this);   	
        conn      = wsconn.getConn();
    }
